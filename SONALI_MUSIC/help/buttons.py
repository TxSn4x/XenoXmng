...
class BUTTONS(object):
    ...
    PBUTTON = [
        [
            InlineKeyboardButton("ᴏᴡɴᴇʀ", url="https://t.me/xeenixx")
        ],
        [
    ...
    ABUTTON = [
        [
            InlineKeyboardButton("⌯ sυᴘᴘσʀᴛ ⌯", url="https://t.me/aniweb_bots"),
            InlineKeyboardButton("⌯ υᴘᴅᴧᴛєs ⌯", url="https://t.me/aniweb_nexus"),
        ],
        [
